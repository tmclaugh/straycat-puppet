...
class jana::svc::puppet::master (
  ...
  if $bootstrap {
    ...
    file { '/etc/puppet/manifests/site.pp':
      ...
      group   => 'root',
      mode    => '0644',
      content => template('jana/svc/puppet/bootstrap-site.pp'),
  ...
  file { '/etc/puppet/puppet_psk':
    ...
    group   => 'puppet',
    mode    => '0440',
    content => template('jana/svc/puppet/puppet_psk')
  }
  ...
  file { $puppet_autosign_script:
    ...
    group   => 'puppet',
    mode    => '0555',
    content => template('jana/svc/puppet/puppet_autosign.py')
  }
